...
ActiveRecord::Schema.define(version: 20161002072247) do
  ...
  create_table "monsters", force: :cascade do |t|
    ...
    t.index ["team_id"], name: "index_monsters_on_team_id", using: :btree
    t.index ["type_id"], name: "index_monsters_on_type_id", using: :btree
